...
| Setting | Value |
|--------|--------|
| Image | `bkunzmann/assurewallos:0.2.0` (Docker tag **without** `v`; Git release tag is `v0.2.0`) |
...
Published image tags follow the Git tag: `v0.2.0` → Docker tags `0.2.0`, `0.2`, and optionally `latest`. Branch pushes alone do **not** build images; use `workflow_dispatch` for ad-hoc builds.
